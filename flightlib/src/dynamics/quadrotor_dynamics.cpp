...
bool QuadrotorDynamics::updateParams(const YAML::Node& params) {
  ...
  policy_time_constant_ = params["quadrotor_dynamics"]["policy_time_constant"].as<Scalar>();
  time_constant_from_state_ = params["quadrotor_dynamics"]["time_constant_from_state"].as<bool>();
  dynamics_time_constant_ = params["quadrotor_dynamics"]["dynamics_time_constant"].as<Scalar>();
